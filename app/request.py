...
def get_sources():
    ...
    """
    get_sources_url = 'https://newsapi.org/v2/top-headlines/sources?apiKey=3e00bee67dfd4c239e7770a7ebc507ad'
...
def get_articles(id):
    ...
    get_articles_url = 'https://newsapi.org/v2/everything?sources={}&apiKey=3e00bee67dfd4c239e7770a7ebc507ad'.format(id)
